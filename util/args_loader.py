...
def get_args():
    ...
    parser.add_argument('-b', '--batch-size', default=100, type=int, help='mini-batch size')
    ...
    parser.add_argument('--attention', action='store_true', help='attention based matching')
    parser.add_argument('--spatial', action='store_true', help='')
    parser.add_argument('--feat_dim', default=80, type=int, help='the dimension of the projection features')
    parser.add_argument('--checkpoint', default='./checkpoints/CIFAR-100/resnet34-supcon/ckpt_bsz_128_epoch_500_scl.pth',
                        type=str, help='pretrained model root')
    parser.add_argument('--ckp', default='', type=str, help='pretrained model root')
