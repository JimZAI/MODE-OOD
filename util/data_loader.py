...
def get_loader_in(args, config_type='default', split=('train', 'val')):
    ...
    if args.in_dataset == "CIFAR-10":
        # Data loading code
        if 'train' in split:
            trainset = torchvision.datasets.CIFAR10(root='/mnt/hdd4/zhangji/OOD-datasets/cifar-10', train=True, download=True, transform=config.transform_train)
            train_loader = torch.utils.data.DataLoader(trainset, batch_size=config.batch_size, shuffle=True, **kwargs)
        if 'val' in split:
            valset = torchvision.datasets.CIFAR10(root='/mnt/hdd4/zhangji/OOD-datasets/cifar-10', train=False, download=True, transform=transform_test)
...
def get_loader_out(args, dataset=('tim', 'noise'), config_type='default', split=('train', 'val')):
    ...
    if 'val' in split:
        ...
        if val_dataset == 'SVHN':
            val_ood_loader = torch.utils.data.DataLoader(SVHN('/mnt/hdd4/zhangji/OOD-datasets/svhn/', split='test', transform=transform_test, download=False),
            ...
            val_ood_loader = torch.utils.data.DataLoader(torchvision.datasets.ImageFolder(root="/mnt/hdd4/zhangji/OOD-datasets/dtd/dtd/images", transform=transform),
                                                       batch_size=batch_size, shuffle=True, num_workers=2)
        elif val_dataset == 'places365':
            val_ood_loader = torch.utils.data.DataLoader(torchvision.datasets.ImageFolder(root="/mnt/hdd4/zhangji/OOD-datasets/places365", transform=transform_test),
                                                       batch_size=batch_size, shuffle=True, num_workers=2)
            ...
            val_ood_loader = torch.utils.data.DataLoader(torchvision.datasets.CIFAR10(root='/mnt/hdd4/zhangji/OOD-datasets/cifar-10', train=False, download=True, transform=transform_test),
                batch_size=batch_size, shuffle=True, num_workers=2)
            ...
            if val_dataset == "LSUN":
                val_dataset = "lsun_c/LSUN"
            if val_dataset == "iSUN":
                val_dataset = "isun/iSUN"
            if val_dataset == "LSUN_FIX":
                val_dataset = "lsun_resize/LSUN_resize"
            val_ood_loader = torch.utils.data.DataLoader(torchvision.datasets.ImageFolder("/mnt/hdd4/zhangji/OOD-datasets/{}".format(val_dataset),
